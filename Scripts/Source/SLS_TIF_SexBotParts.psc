...
if (bodyPartsCount > 0)
	...
	newSexBotOutfit  = _SLS_SexBotRepairStates[_SLS_SexBotRepairLevel.GetValue() as Int]

	; Debug.Notification("SexBot: index = " + _SLS_SexBotRepairLevel.GetValue() as Int + " - Outfit: " + newSexBotOutfit  )
