...
Scriptname SLS_TIF_RedWaveService05 Extends TopicInfo Hidden
...
Game.GetPlayer().RemoveItem(Gold001, 100)
	...
	If  (SexLab.ValidateActor( SexLab.PlayerRef ) > 0) &&  (SexLab.ValidateActor(akSpeaker) > 0) 
		...
		If (PlayerGender  == 1)
			Thread.SetAnimations(SexLab.GetAnimationsByTags(2, "Aggressive,Lesbian"))
		Else
			Thread.SetAnimations(SexLab.GetAnimationsByTags(2, "Aggressive,MF"))
		EndIf
