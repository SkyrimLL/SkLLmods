...
;BEGIN CODE
; TG - F to TG
Debug.Messagebox("My boobs are shrinking.. and my clit! it grows a little more with each sex act!  I must find someone who knows about this gender bending curse and hopefully, find a way to end it before it is too late.")
;END CODE
EndFunction
;END FRAGMENT
