Scriptname SLS_PlayerPetAlias extends ReferenceAlias  


ReferenceAlias Property PlayerAlias  Auto  
SexLabFramework     property SexLab Auto

Quest Property SLS_PlayerPetQuest  Auto  

; objectreference property SLS_PlayerNordQueenStorage auto

ObjectReference Property NecromancerSlaver Auto
...
Function _Maintenance()
	...
	If (!StorageUtil.HasIntValue(none, "_SLS_iStoriesPlayerPet"))
	 	StorageUtil.SetIntValue(none, "_SLS_iStoriesPlayerPet", 0)
	EndIf
	...
	RegisterForModEvent("_SLS_PlayerPet", "OnPlayerPet")
...
Event OnUpdate()
	...
	elseIf (StorageUtil.GetIntValue(none, "_SLS_iStoriesPlayerPet")==1)
		; _RefreshQueenFX()
...
Event OnPlayerPet(String _eventName, String _args, Float _argc = -1.0, Form _sender)
 	Actor kActor = _sender as Actor
 	Actor PlayerActor= Game.GetPlayer() as Actor

	StorageUtil.SetIntValue(none, "_SLS_iStoriesPlayerPet", 1)

	If (!(StorageUtil.HasIntValue(none, "_SLS_iPlayerStartPet")))
		StorageUtil.SetIntValue(none, "_SLS_iPlayerStartPet", 0)
	EndIf
...
Event OnSexLabEnd(String _eventName, String _args, Float _argc, Form _sender)
	...
	if !Self || !SexLab  || (StorageUtil.GetIntValue(none, "_SLS_iStoriesPlayerPet")==0)
...
Event OnSexLabOrgasm(String _eventName, String _args, Float _argc, Form _sender)
	...
	If (_hasPlayer(actors))
		If (_hasRace(actors, DremoraRace))
