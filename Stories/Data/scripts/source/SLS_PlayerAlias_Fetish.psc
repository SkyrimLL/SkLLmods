...
Event OnPCStartPet(String _eventName, String _args, Float _argc = -1.0, Form _sender)
	...
	PlayerActor.SendModEvent("SDEquipDevice",   "PlugAnal|Dremora")
	PlayerActor.SendModEvent("SDEquipDevice",   "Plugvaginal|Dremora")
	PlayerActor.SendModEvent("SDEquipDevice",   "Belt|Dremora")
	PlayerActor.SendModEvent("SDEquipDevice",   "Armbinder|Dremora")
