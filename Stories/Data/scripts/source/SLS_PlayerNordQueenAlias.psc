...
Event OnPlayerNordQueen(String _eventName, String _args, Float _argc = -1.0, Form _sender)
	...
	PlayerActor.SendModEvent("SLHSetNiNode","Breast", 0.2 )  
	...
	If (bUpdateStage)
		...
		If  (iSexEnergy == 0) 
			...
			If (StorageUtil.GetIntValue(none, "_SLH_iHormones") ==1)
				...
				PlayerActor.SendModEvent("SLHSetNiNode","Breast", 0.3 )
				PlayerActor.SendModEvent("SLHSetNiNode","Belly", 0.6 )
				PlayerActor.SendModEvent("SLHSetNiNode","Butt", 0.6 ) 
				StorageUtil.SetFloatValue(PlayerActor, "_SLH_fWeight", 0.0 )  
				PlayerActor.SendModEvent("SLHRefresh")
			Endif		
		...
		ElseIf  (iSexEnergy >= 1) && (iSexEnergy < 5) && (iPlayerPolymorphStage!=1)
			...
			If (StorageUtil.GetIntValue(none, "_SLH_iHormones") ==1)
				...
				PlayerActor.SendModEvent("yps-SetPubicHairLengthEvent", "", 0)
				PlayerActor.SendModEvent("yps-SetArmpitsHairLengthEvent", "", 0)
				PlayerActor.SendModEvent("SLHSetNiNode","Breast", 0.5 )
				PlayerActor.SendModEvent("SLHSetNiNode","Belly", 0.8 )
		...
		ElseIf  (iSexEnergy >= 5) && (iSexEnergy < 10) && (iPlayerPolymorphStage!=2)
			...
			If (StorageUtil.GetIntValue(none, "_SLH_iHormones") ==1)
				...
				PlayerActor.SendModEvent("yps-SetPubicHairLengthEvent", "", 0)
				PlayerActor.SendModEvent("yps-SetArmpitsHairLengthEvent", "", 0)
				PlayerActor.SendModEvent("SLHSetNiNode","Breast", 0.7 )
				PlayerActor.SendModEvent("SLHSetNiNode","Belly", 0.9 )
		...
		ElseIf  (iSexEnergy >= 10) && (iSexEnergy < 20) && (iPlayerPolymorphStage!=3)
			...
			If (StorageUtil.GetIntValue(none, "_SLH_iHormones") ==1)
				...
				PlayerActor.SendModEvent("SLHSetNiNode","Belly", 1.0 )
				PlayerActor.SendModEvent("SLHSetNiNode","Butt", 1.0 ) 
		...
		ElseIf  (iSexEnergy >= 20) && (iPlayerPolymorphStage!=4)
			...
			If (StorageUtil.GetIntValue(none, "_SLH_iHormones") ==1)
				PlayerActor.SendModEvent("SLHSetNiNode","Breast", 1.5 )
				PlayerActor.SendModEvent("SLHSetNiNode","Belly", 1.2 )
				PlayerActor.SendModEvent("SLHSetNiNode","Butt", 1.2 ) 
