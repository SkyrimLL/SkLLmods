...
Scriptname SL_Dibella_TIF_InitiationTask05 Extends TopicInfo Hidden

;BEGIN FRAGMENT Fragment_0
Function Fragment_0(ObjectReference akSpeakerRef)
Actor akSpeaker = akSpeakerRef as Actor
;BEGIN CODE
Self.GetOwningQuest().SetObjectiveDisplayed(16, abDisplayed=False)
Self.GetOwningQuest().SetStage(13)

DibellaPathQuest.SetStage(30)
...
StorageUtil.SetIntValue( akSpeaker, "_SLSD_iInitiationLessonCount", InitiationLessonCount.GetValue() as Int )
	...
	If  (SexLab.ValidateActor( SexLab.PlayerREF) > 0) &&  (SexLab.ValidateActor(akSpeaker) > 0) 
		...
		If (akActor.GetActorBase().getSex() == 1)
			Thread.SetAnimations(SexLab.GetAnimationsByTags(2, "Dirty,Lesbian", "Aggressive"))
		Else
			Thread.SetAnimations(SexLab.GetAnimationsByTags(2, "Dirty,MF", "Aggressive"))
		EndIf
