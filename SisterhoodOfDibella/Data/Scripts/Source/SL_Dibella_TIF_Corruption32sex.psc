...
Scriptname SL_Dibella_TIF_Corruption32sex Extends TopicInfo Hidden
...
if (akSpeaker.GetRelationshipRank(Game.GetPlayer()) <= 4)
	...
	Debug.Notification(actorName  + " is now your Lover and Master")
	...
	If  (SexLab.ValidateActor( Game.GetPlayer() ) > 0) &&  (SexLab.ValidateActor(akSpeaker) > 0) 
		...
		SexLab.QuickStart( Game.GetPlayer(), akSpeaker, AnimationTags = "Anal")
	EndIf
;END CODE
EndFunction
;END FRAGMENT
