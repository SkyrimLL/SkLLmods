...
Scriptname SL_Dibella_TIF_Corruption32sexforced Extends TopicInfo Hidden
...
if (akSpeaker.GetRelationshipRank(Game.GetPlayer()) <= 4)
	...
	Debug.Notification(actorName  + " is now your Lover and Slave")
	...
	If  (SexLab.ValidateActor( Game.GetPlayer() ) > 0) &&  (SexLab.ValidateActor(akSpeaker) > 0) 
		...
		SexLab.QuickStart(akSpeaker, Game.GetPlayer(),  AnimationTags = "Sex")
	EndIf
;END CODE
EndFunction
;END FRAGMENT
